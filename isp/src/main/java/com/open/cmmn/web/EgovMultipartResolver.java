...
/**
 * <pre>
 * Class Name : EgovMultipartResolver.java
 * Description: 실행환경의 파일업로드 처리를 위한 기능 클래스.
...
public class EgovMultipartResolver extends CommonsMultipartResolver {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(EgovMultipartResolver.class);

	/**
	 * Constructor of EgovMultipartResolver class.
	 */
	...
	/**
	*<pre>
	* Description :  Constructor of EgovMultipartResolver class.
	*</pre>
	* @param servletContext ServletContext
	 */
	public EgovMultipartResolver(final ServletContext servletContext) {
	...
	/**
	 * @see org.springframework.web.multipart.commons.CommonsFileUploadSupport#parseFileItems(java.util.List,
	 *      java.lang.String)
	 */
	@SuppressWarnings("rawtypes")
	@Override
	protected final MultipartParsingResult parseFileItems(final List fileItems,
		...
		for (Iterator<?> it = fileItems.iterator(); it.hasNext();) {
			...
			if (fileItem.isFormField()) {
				...
				if (curParam == null) {
					...
					String[] newParam =
							StringUtils.addStringToArray(curParam, value);
