...
public class EncryptUtil {
	...
	public static byte[] Sha256EncryptB(byte[] plainTextByte) throws Exception {
	...
	*/
	public static void SHA256_Close( SHA256_INFO Info, byte[] pszDigest ) {
		...
		int_to_byte_unit(Info.szBuffer, (SHA256_DIGEST_BLOCKLEN / 4 - 2)*4, Info.uHighLength, ENDIAN);
		int_to_byte_unit(Info.szBuffer, (SHA256_DIGEST_BLOCKLEN / 4 - 1)*4, Info.uLowLength, ENDIAN);
	...
	*/
	...
	// 암호화 
	public static byte[] aesEncryptEcb(String sKey, String sText) throws Exception{
        byte[] key = null;
        byte[] text = null;
        byte[] encrypted = null;
    ...
    // 복호화
	public static byte[] aesDecryptEcb(String sKey, byte[] encrypted) throws Exception{
        byte[] key = null;
        byte[] decrypted = null;
        final int AES_KEY_SIZE_128 = 128;
    ...
    @SuppressWarnings("unused")
	public static byte[] aesEncryptCbc(String sKey, String sText) throws Exception {
        return aesEncryptCbc(sKey, sText, "");
    }
 
    @SuppressWarnings("unused")
	public static byte[] aesDecryptCbc(String sKey, byte[] encrypted) throws Exception {
        return aesDecryptCbc(sKey, encrypted, "");
    }
 
    public static byte[] aesEncryptCbc(String sKey, String sText, String sInitVector) throws Exception{
        byte[] key = null;
        byte[] text = null;
        byte[] iv = null;
        byte[] encrypted = null;
    ...
    private static byte[] aesDecryptCbc(String sKey, byte[] encrypted, String sInitVector) throws Exception{
        byte[] key = null;
        byte[] iv = null;
        byte[] decrypted = null;
        final int AES_KEY_SIZE_128 = 128;
    ...
    final static String secretKey   = "on3456789012345678901234567890on"; //32bit
