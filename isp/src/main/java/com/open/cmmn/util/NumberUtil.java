...
public class NumberUtil {
	...
	/** LOG .*/
	static protected Log log = LogFactory.getLog(NumberUtil.class);

	public static int getRandomNum(int startNum, int endNum) throws Exception{
	 ...
	 * @see
	 */
	public static String getNumToStrCnvr(int srcNumber) throws Exception{
	 ...
	 * @see
	 */
	public static Boolean getNumberValidCheck(String checkStr) throws Exception{
	...
	public static int getNumberCnvr(int srcNumber, int cnvrSrcNumber, int cnvrTrgtNumber) throws Exception{
	...
	public static double getMathRound(double num,int check) {
		double resultNum = 0;
		resultNum=Math.round((num*100))/Math.pow(10.0,check);
		return resultNum;
