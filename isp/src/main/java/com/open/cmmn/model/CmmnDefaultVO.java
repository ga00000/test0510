...
public class CmmnDefaultVO implements Serializable {
	...
	// 사용자 loginSeq
	public String getFrontLoginSeq() throws Exception {
		if (SessionUtil.getFtUserDetails() != null) {
			return StringUtil.nullString(SessionUtil.getFtUserDetails().getFtSeq());
		} else {
			return "";
		}
	}

	public void setFrontLoginSeq(String frontLoginSeq) {
		this.frontLoginSeq = frontLoginSeq;
	}
