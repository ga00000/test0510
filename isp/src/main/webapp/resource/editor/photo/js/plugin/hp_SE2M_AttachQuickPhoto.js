...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	makePopupURL : function(){
		//var sPopupUrl = "/resource/editor/photo/photo_uploader/photo_uploader.html";
		var sPopupUrl = "/manage/atch/editorUploadForm.do";
		...
		try{
			...
			for(var i = 0; i <aPhotoData.length; i++){				
				...
				aPhotoInfo = {
					...
					altText : htData.altText ,
					imageWidth : htData.imageWidth ,
					imageHeight : htData.imageHeight 
				};
	...
	_getPhotoTag : function(htPhotoInfo){
		...
		var sTag = '<img src="{=sOriginalImageURL}" alt="{=altText}" title="{=sName}" width="{=imageWidth}" height="{=imageHeight}" />';
