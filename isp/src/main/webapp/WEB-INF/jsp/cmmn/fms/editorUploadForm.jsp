...
#pop_footer{margin:21px 20px 0;padding:10px 0 16px;text-align:center}
...
.pop_container .drag_area .bg{display:block;position:absolute;top:0;left:0;width:341px;height:129px;background:#fdfdfd url(/resource/editor/photo/photo_uploader/img/bg_drag_image.png) 0 0 no-repeat}
...
.pop_container2{padding:26px 0 10px 10px;}
.dsc{margin-top:16px;color:#666;line-height:18px}
.pop_container2 .dsc strong{color:red;}
.upload{margin:0 4px 0 0;_margin:0;padding:6px 0 4px 6px;border:solid 1px #d5d5d5;color:#a1a1a1;font-size:12px;border-right-color:#efefef;border-bottom-color:#efefef;length:300px;width:350px;}
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2" style="display: none;">
        ...
        <div id="pop_content2">
            <div class=Cont><label for="altText">대체 텍스트</label></span>
	            <div class="Cont">
	            	<input type="text" class="upload" id="altText" name="altText"/>
	            </div>
       		</div>
     	</div>
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="#"><img src="/resource/editor/photo/photo_uploader/img/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="/resource/editor/photo/photo_uploader/img/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
    <!-- //footer -->
</div>
<script type="text/javascript" src="/resource/editor/photo/photo_uploader/jindo.min.js" charset="utf-8"></script>
<script type="text/javascript" src="/resource/editor/photo/photo_uploader/jindo.fileuploader.js" charset="utf-8"></script>
<script type="text/javascript" src="/resource/editor/photo/photo_uploader/attach_photo.js" charset="utf-8"></script>
<script type="text/javascript" src="/publish/ma/js/jquery-1.11.3.min.js"></script>
<script type="text/javascript"> 

var fncFileUp = function(tempFile,sUploadURL){
