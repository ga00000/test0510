...
<div class="content_box">
	<form:form commandName="portVO" name="defaultFrm" id="defaultFrm" method="post">
			...
			<table class="tbl_row_type01"> 
				...
				<tbody>
					<tr>
						...
						<td colspan="3">
							<input type="text" name="ptTitle" id="ptTitle" class="text w100p"   maxlength="30" value="${portVO.ptTitle}" />
						</td>
					</tr>
					
					<tr>
						<th scope="row"><strong class="th_tit">게시판</strong></th>
						<td colspan="3">
							<select id="ptSelect" name="ptSelect">
								<option value="case"> 시공사례 </option>
								<option value="design"> 추천설계 </option>
								<option value="place"> 시공현장 </option>
								<option value="interior"> 인테리어사례 </option>
							</select>
						</td>
					</tr>
...
function btnSubmit(){
	...
	if($("#ptCont").val()=='<p>&nbsp;</p>') {
		alert("내용을 입력해주세요");
		oEditors.getById["ptCont"].exec("FOCUS"); /* 에디터 */
		count++;
	}		
	if(count>0){
		count=0;
