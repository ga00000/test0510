...
<div class="join_wrap">
    ...
    <h2>회원가입</h2>
        <ul class="join js-join">
            ...
            <li>
                <div class="input_box">
                    <span class="i_em">아이디</span><input type="text" class="text js-text" maxlength="10" name="ftId" id="ftId" placeholder="아이디" />
               		 <a href="#" class="btn_identify js-btn-identify" onclick="checkIdDup();">아이디 중복확인</a>
                </div>
            </li>
            ...
            <li>
                <div class="input_box">
                    <span class="i_nm">이름</span><input type="text" class="text js-text" maxlength="10" name="ftName" id="ftName" placeholder="이름" />
                </div>
            </li>
            <li class="last">
                <div class="input_box">
                    <span class="i_ph">핸드폰번호</span><input type="text" class="text js-text" maxlength="10" name="ftHp" id="ftHp" placeholder="휴대폰 번호" />
             ...
             <li class="last">
                <div class="input_box">
                    <span class="i_em">이메일</span><input type="text" class="text js-text" maxlength="10" name="ftEmail" id="ftEmail" placeholder="이메일" />
