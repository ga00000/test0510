...
<div class="join_wrap">
    ...
    <h2>비밀번호 확인</h2>
        <ul class="join js-join">
         ...
         <li>
                <div class="input_box">
                    <span class="i_nm"></span><input type="text" class="text js-text" maxlength="10" name="ftId" id="ftId" value="${loginFtId }" disabled />
                </div>
            </li>
         ...
         <li>
            ...
            <div class="join_btns">
     			  <a href="#" class="btn btn_big btn_join" onclick="btnPw();">확인</a>
 		   </div>
 		  </ul>
    </div>
...
function btnPw(){ 
	...
	fncPageBoard('view','pwCheckProc.do');
	return false; 
}
