...
<div class="join_wrap">
    ...
    <h2>아이디찾기</h2>
        <ul class="join js-join">
         ...
         <li>
                <div class="input_box">
                    <span class="i_nm">이름</span><input type="text" class="text js-text" maxlength="10"  id="ftNameFind" placeholder="이름" />
                </div>
            </li>
            
            <li class="last">
                <div class="input_box">
                    <span class="i_em">이메일</span><input type="text" class="text js-text" maxlength="10"  id="ftEmailFind" placeholder="이메일" />
            ...
            <div class="join_btns">
     			  <a href="#" class="btn btn_big btn_join" onclick="btnFindId();">아이디찾기</a>
 		   </div>
 		  </ul>
 	 ...
 	 <h2>비밀번호찾기</h2>
        <ul class="join js-join">
            ...
            <div class="join_btns">
     			  <a href="#" class="btn btn_big btn_join" onclick="btnFindPw();">비밀번호찾기</a>
 		   </div> 
...
function btnFindId(){ 
	...
	if($("#ftNameFind").val() == "" || $("#ftNameFind").val() == null) {
		fncMsg("ftNameFind", "이름를 입력하세요.")
		count++;
	}
	if($("#ftEmailFind").val() == "" || $("#ftEmailFind").val() == null) {
		fncMsg("ftEmailFind", "이메일을 입력하세요.")
		count++;
	}
	if(count>0){
		count = 0;
	   ...
	   $.ajax({  
		   ...
		   success: function(data) {
			   if(data!=""){
			   	var fncHtml = '<font color = "red">아이디는 '+data+'입니다.'
