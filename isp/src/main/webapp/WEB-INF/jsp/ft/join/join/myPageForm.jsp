...
<div class="join_wrap">
    <div class="join_form">
    <h2>마이페이지</h2>
        <input type="checkbox" id="pwUpdate" /> 비밀번호 수정 
        
        <ul class="join js-join">
            <li>
                <div class="input_box">
                    <span class="i_em">아이디</span><input type="text" class="text js-text" maxlength="10" name="ftId" id="ftId" value="${ftJoinVO.ftId}" disabled />
               		 <font color="red">아이디는 수정불가합니다.</font>
                </div>
            </li>
            
            <li style="display:none;" class="pwArea">
                <div class="input_box" >
                    <span class="i_pw">비밀번호</span><input type="password" maxlength="10" class="text js-text" name="ftPwd" id="ftPwd"placeholder="비밀번호" />
                </div>
            </li>
            
            <li  style="display:none;" class="pwArea">
                <div class="input_box">
                    <span class="i_pwr">비밀번호확인</span><input type="password" maxlength="10" class="text js-text "  id="ftPwdCheck" placeholder="비밀번호 확인" />
                </div>
            </li>
            
            <li>
                <div class="input_box">
                    <span class="i_nm">이름</span><input type="text" class="text js-text" maxlength="10" name="ftName" id="ftName" placeholder="이름" value="${ftJoinVO.ftName}"/>
                </div>
            </li>
            <li class="last">
                <div class="input_box">    
                    <span class="i_ph">핸드폰번호</span><input type="text" class="text js-text" maxlength="10" name="ftHp" id="ftHp" placeholder="휴대폰 번호" value="${ftJoinVO.ftHp}" />
             ...
             <li class="last">
                <div class="input_box">
                    <span class="i_em">이메일</span><input type="text" class="text js-text" maxlength="10" name="ftEmail" id="ftEmail" placeholder="이메일" value="${ftJoinVO.ftEmail}"/>
...
function btnJoin(){
	...
	if($("#ftName").val() == "" || $("#ftName").val() == null) {
		fncMsg("ftName", "이름를 입력하세요.")
		count++;
	}
	if($("#ftHp").val() == "" || $("#ftHp").val() == null) {
		fncMsg("ftHp", "핸드폰 번호를 입력하세요.")
		count++;
	}
